...
Notice that each line starts with `!`
...
With opt-out it’s easy to be forgetful. Does your `.dockerignore` contain `.git`? Have you added `node_modules`? You probably have because builds were *slow*, but what else have you forgotten?
