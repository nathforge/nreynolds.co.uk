...
Say we want to run different variants of services for testing. For the UI it’s easy solve because the UI initiates requests - downstream services don’t connect back to it, so you can have as many UIs as you want.
